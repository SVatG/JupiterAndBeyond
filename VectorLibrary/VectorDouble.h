...
static inline bool dvec2almostequal(dvec2_t a,dvec2_t b,double epsilon) { return fabsf(a.x-b.x)<epsilon && fabsf(a.y-b.y)<epsilon; }
static inline bool dvec3almostequal(dvec3_t a,dvec3_t b,double epsilon) { return fabsf(a.x-b.x)<epsilon && fabsf(a.y-b.y)<epsilon && fabsf(a.z-b.z)<epsilon; }
static inline bool dvec4almostequal(dvec4_t a,dvec4_t b,double epsilon) { return fabsf(a.x-b.x)<epsilon && fabsf(a.y-b.y)<epsilon && fabsf(a.z-b.z)<epsilon && fabsf(a.w-b.w)<epsilon; }

...
{
	dvec2_t col1=dmat2x2_col1(m),col2=dmat2x2_col1(m);
...
static inline bool dmat2x2almostequal(dmat2x2_t a,dmat2x2_t b,double epsilon) { for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) if(fabsf(a.m[i]-b.m[i])<epsilon) return false; return true; }
static inline bool dmat3x2almostequal(dmat3x2_t a,dmat3x2_t b,double epsilon) { for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) if(fabsf(a.m[i]-b.m[i])<epsilon) return false; return true; }
static inline bool dmat3x3almostequal(dmat3x3_t a,dmat3x3_t b,double epsilon) { for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) if(fabsf(a.m[i]-b.m[i])<epsilon) return false; return true; }
static inline bool dmat4x3almostequal(dmat4x3_t a,dmat4x3_t b,double epsilon) { for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) if(fabsf(a.m[i]-b.m[i])<epsilon) return false; return true; }
static inline bool dmat4x4almostequal(dmat4x4_t a,dmat4x4_t b,double epsilon) { for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) if(fabsf(a.m[i]-b.m[i])<epsilon) return false; return true; }
